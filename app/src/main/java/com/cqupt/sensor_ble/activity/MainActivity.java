...
public class MainActivity extends Activity {
    ...
    private TextView status, humidity, temperature, tv_bluetooth_name, tv_battery, tv_rssi;
    ...
    private final BroadcastReceiver UARTStatusChangeReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(UartService.ACTION_GATT_DISCONNECTED)) {
                ...
                status.setText(getString(R.string.bt_disconnect));
                humidity.setText(getString(R.string.humidity, 0));
                temperature.setText(getString(R.string.temperature, 0));
            }
            /**
             * 获取数据
             */
